...
def run():
    ...
    for n in range(MIN_NODES, MAX_NODES + 1):
        ...
        logging.info(f"Brute Force Algorithm: {max_length_bf} in {time_elapsed_bf} seconds")
        logging.info(f"Greedy Algorithm:      {max_length_greedy} in {time_elapsed_greedy} seconds")
        logging.info("----------------------------------------------------------")
